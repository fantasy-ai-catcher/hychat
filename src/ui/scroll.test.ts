...
describe('buildRenderLines', () => {
  ...
  it('emits a colored, dim reply-quote row; the body stays at the margin', () => {
    ...
    // Body row is a normal text row (no special bar flag).
